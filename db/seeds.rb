...
ActiveRecord::Base.transaction do
    ...
    assembly = Space.create!({name: "The Assembly", shared_desk: 265, phone_booths: 0, meeting_rooms: 0, hours_24_access: false, transit_station_miles: 0.4, wellness_room: true, people_capacity: 600, office_capacity: 0, availability: true, desk_day: true, address: "449 14th St., Mission District", city: "San Francisco", state: "CA", zipcode: 94103, neighborhood: "SOMA", phone: "‭(415) 868-3322‬", description: "The Assembly is a wellbeing club that makes people feel good with exceptional workouts, wellness, food, community, and connection.", email: "aloha@theassembly.com", website: "https://www.theassembly.com/", cost: 250, open_hour: "8am", closing_hour: "8pm"})
    ...
    wing = Space.create!({name: "The Wing", shared_desk: 215, phone_booths: 10, meeting_rooms: 10, hours_24_access: false, transit_station_miles: 0.1, wellness_room: true, people_capacity: 500, office_capacity: 10, availability: true, desk_day: false, address: "115 Sansome St Suite #200", city: "San Francisco", state: "CA", zipcode: 94104, neighborhood: "Financial District", phone: "N/A", description: "A haven in the Financial District, our first West Coast Wing features a café with local flavors, an idyllic beauty room, and sun-drenched corners. We recently doubled in size, adding a fitness room, dedicated event space, and more room to spread out.", email: "sup@the-wing.com", website: "https://bespokesf.co/", cost: 185, open_hour: "8am", closing_hour: "9pm"})
    ...
    shared = Space.create!({name: "Shared", shared_desk: 315, phone_booths: 0, meeting_rooms: 8, hours_24_access: false, transit_station_miles: 0.5, wellness_room: false, people_capacity: 250, office_capacity: 10, availability: true, desk_day: false, address: "739 Bryant St", city: "San Francisco", state: "CA", zipcode: 94107, neighborhood: "Mission Bay", phone: "415-317-5905", description: "SHARED is a space that houses a community of creative people who value sharing.", email: "membership@shared-sf.com", website: "http://www.shared-sf.com/", cost: 275, open_hour: "6am", closing_hour: "2am"})
