...
ActiveRecord::Base.transaction do
    ...
    bespoke = Space.create!({name: "Bespoke", address: "845 Market St Suite 45", city: "San Francisco", state: "CA", zipcode: 94103, phone: "(415) 964-4815", description: "Bespoke is a collection of tech-forward spaces, tailored for in-person inspiration.", email: "contact@bespokesf.co", parking: true, wifi_included: true, website: "https://bespokesf.co/", cost: 416, open_hour: "9am", closing_hour: "6pm"})
